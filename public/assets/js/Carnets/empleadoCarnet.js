//-----------------cargar datos de empleado para modificar carnets--------------------------------

$(".editEmpleado").click(function(event){
	var id = $(this).attr("empleadoId");

	$.get(`editarEmpleado/${id}`, function(response, editEmpleado){
		...
		$.get(`editEmpleadoCC/${id}`, function(response, editEmpleado){
		...
		$("#empleadoCarnet").append(`
			<div class="form-group col-md-12" >
				...
				<div id='previo_carnetM' style='border-radius:5px; margin:45px 5px 0 310px; border:1px solid #999; height:371px; width:233px; background:url(imagenes/${foto}); display:block; line-height:11px;display:block; line-height:11px; overflow: hidden;  background-size: 233px, 345px; background-repeat: no-repeat;'>
						...
						<div id='foto_info_previa' style='padding:163px 0 0px 5px'>
							<div id="rombo2" style="margin-top:103px;">
					        	<div class="ima">
					        		<img id='foto_carnet_previa' src='imagenes/${perfil}'  style="width: 88%;"/>
					        	</div>
					        </div>
...
$("#imprimirCarnet").click(function(){
	...
	var motivo = $("#motivoReporte").val();
	var sello = $("#selloPrensaM").val();
	var fechaVencimiento = $("#empleadoFechaVecim").val();

	if ((motivo == "") || (sello == "") || (fechaVencimiento == "")) {
...
$("#motivoCa").click(function(){

	var motivo = $("#motivoReportes").val();

	if (motivo == 7) {
		$("#tipoCarnet").fadeIn("slow");
		$("#ImprimeCod").fadeIn("slow");
		$("#reportarCarnet").fadeOut("slow");
	}else if (motivo != 7) {
		$("#tipoCarnet").fadeOut("slow");
		$("#ImprimeCod").fadeOut("slow");
		$("#reportarCarnet").fadeIn("slow");
	}
...
//-----------------cargar datos de empleado para crear o modificar carnets Fin -------------------------------
...
$(".verCarnet").click(function(event){
		...
		/*	if((cod_car == '0000000407') || (cod_car == '0000000431') || 
			...
			var cod_uni = element.cod_uni;
			 ...
			 if((cod_uni == '0000-00-04-01-01') || (cod_uni == '0000-00-04-01-00') || 
				...
				(cod_uni == '0000-00-05-00-00') || (cod_uni == '0000-00-30-00-01') ||
				(cod_uni == '0000-00-05-02-00')
				){   //VPGT - Tec - Ing -servicios a la produccion - operaciones tecnicas -comunicaciones -sedes
	...
	//}
		...
		$('#empleadoFechaVecimm').val(element.fecha)
		...
		<div id="vistaPreviaCarnet">
				...
				<div id='vista_previa'>
					...
					<div id='previo_carnetV' style='border-radius:5px; margin:10px 5px 0 160px; border:1px solid #999; height:372px; width:233px; background:url(${fondo}); display:block; line-height:11px;display:block; line-height:11px; overflow: hidden;  background-size: 233px, 372px; background-repeat: no-repeat;'>
						...
						<div id='foto_info_previa' style='padding:170px 0 0px 5px'>
							<div id="rombo2" style="margin-top: -112px; margin-right: -150px;">
					        	<div class="ima">
...
$("#cambioFoto").click(function(){
	...
	var tipo = $("#cambioFoto").val();

	if (tipo == "Si") {

		$(".nuevaFoto").fadeIn("slow");

	}else{

		$(".nuevaFoto").fadeOut("slow");
