...
<br>
  ...
  <div class="form-group col-xs-3" style="">
    ...
    <div class="input-group">
      <input type="text" class="form-control" id="buscaExtraviados" placeholder="Buscar... Serial, Cédula" required="">
      <div class="input-group-addon"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></div>
    </div>
  </div>

<form method="post" action="buscaFechasExtraviados" name="" >
 {{ csrf_field() }}
  <div class="form-group col-xs-4" style="">
    <label class="sr-only" for="exampleInputAmount">Desde</label>
    <div class="input-group">
      <input type="text" class="form-control" name="fechadesdeE" id="desde" placeholder="Fecha...Desde" >
      <div class="input-group-addon"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></div>
    </div>
  </div>
    ...
    <div class="input-group">
      <input type="text" class="form-control" name="fechahastaE" id="hasta" placeholder="Fecha...Hasta">
      <div class="input-group-addon"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></div>
    </div>
  </div>
<div class="">
...
<div class="panel panel-default" style="">
  ...
  <div class="panel-heading" style="background-color: #e5e8e8;">Carnets Extravíados <!-- Boton de la modal -->
    <a href="PDF_Carnet_Extraviado" id="" target="_blank" title="Generar archivo pdf" class="reporte_ce" style="display: none;"> 
...
<?php foreach ($extraviado as $carnet_empleados):
