...
<br>
  ...
  <div class="form-group col-xs-3" style="">
    ...
    <div class="input-group">
      <input type="text" class="form-control" id="buscaRobados" placeholder="Buscar... Serial, Cédula">
      <div class="input-group-addon"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></div>
    </div>
  </div>

<form method="post" action="buscaFechasRobados" name="" >
 {{ csrf_field() }}
  <div class="form-group col-xs-4" style="">
    <label class="sr-only" for="exampleInputAmount">Desde</label>
    <div class="input-group">
      <input type="text" class="form-control" name="fechadesdeR" id="desde" placeholder="Fecha...Desde" required="">
      <div class="input-group-addon"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></div>
    </div>
  </div>
    ...
    <div class="input-group">
      <input type="text" class="form-control" name="fechahastaR" id="hasta" placeholder="Fecha...Hasta" required="">
      <div class="input-group-addon"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></div>
    </div>
  </div>
<div class="">
...
<div class="panel panel-default" style="">
    ...
    <div class="panel-heading" style="background-color: #e5e8e8;">Carnets Robados 
    <a href="PDF_Carnet_Robados" id="" target="_blank" title="Generar archivo pdf" style="display: none;" class="reporte_cr"> 
...
<?php foreach ($robados as $carnet_empleados):
