...
<div class="panel panel-default">
  	...
  	<div class="panel-heading" style="background-color: #e5e8e8;">
  		<b>AUDITORIA PARA LA FECHA {{$desde}} / {{$hasta}}/ {{$dia}} /{{$usuario}}/{{$ipb}}/{{$name_m}}/{{$explorer_m}}</b>

  		<a href="auditoria_searchpdf/{{$desde}}/{{$hasta}}/{{$dia}}/{{$usuario}}/{{$ipb}}/{{$name_m}}/{{$explorer_m}}" title="Generar archivo pdf" target="_blank" > 
            <img src="assets/img/iconos/pdf.svg" style="height: 30px; margin-top: -7" align="right"> 
        </a>
		    					...
		    					<ul class="list-group text-left">
								  	<li class="list-group-item text-left">
								  		...
								  		<label style="margin-left:40px">
											<input class="form-control form-inline" type="date" name="dia" id="diaAud" required>
										</label>
								  	</li>
								  	<li class="list-group-item text-left">
								  		<label>
								  		...
								  		<label style="margin-left: 15px">
											DESDE:
											<input class="form-control form-inline" type="date" name="desde"  disabled="disabled" id="desdeAud" required>
										</label>
										<label style="margin-left: 15px">
											HASTA:
											<input class="form-control form-inline" type="date" name="hasta" disabled="disabled" id="hastaAud" required>
										</label>
								  	</li>
								  	<li class="list-group-item text-left">
								  		<label>
