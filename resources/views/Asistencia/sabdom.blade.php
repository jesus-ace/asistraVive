...
<div class="panel {{$panel}}">
    <form method="POST" action="guardar_status" id="formId">
        ...
        <div class="panel-heading" style="background-color: #e5e8e8;">
            <b>
                RESUMEN GENERAL DE {{$tipo}} PARA LOS FINES DE SEMANA DEL RANGO: {{$fecha}} 
                <a href="generarpdfg/{{$dia}}/{{$desde}}/{{$hasta}}/{{$departamento}}/{{$sabdom}}/{{$tipo}}" title="Generar archivo pdf" target="_blank" id="imprimir_g">
                    <img src="assets/img/iconos/pdf.svg" style="height: 30px; margin-top: -7px;" align="right">
                </a>
            </b>
                <a href="generarexcelgsabdom/{{$dia}}/{{$desde}}/{{$hasta}}/{{$departamento}}/{{$sabdom}}/{{$tipo}}" title="Generar archivo de excel"> 
                    <img src="assets/img/iconos/excel.svg" style="height:30px; margin-top: -7px;display: none;" align="right" class="imprimir_excel"> 
                </a>
        </div>
                    ...
                    @if(count($asistencia)>0)
                        ...
                        if ($fechaa == 'Sabado' || $fechaa == 'Domingo') {
                           echo "<tr>
                                ...
                                <td>
                                    <input type='checkbox' name='status[]' value=".$asi->asi_id." class='habilitados_asi'".$check." >
                                </td>
                            </tr>";
                        }
                        ?>
